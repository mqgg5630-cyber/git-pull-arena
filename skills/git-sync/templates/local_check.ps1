...
# machine when the agent requests one.
# (The generic template lives in skills\git-sync\templates\local_check.ps1 -
#  this copy is the one that actually runs here.) watch.ps1 executes this whenever the agent requests a check
